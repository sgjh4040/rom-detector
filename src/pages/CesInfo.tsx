...
export const CesInfo: React.FC = () => {
  ...
  if (!cesData)
    return <div className="p-8">Data not found for {selectedJointId}</div>;
    ...
    <div className="ces-dashboard page-bg-ces info-mode">
      ...
      <div className="ces-sidebar">
        ...
        <div className="sidebar-menu mt-8">
          <div className="menu-group-label text-[10px] opacity-40 font-bold mb-2 ml-4 tracking-widest uppercase">
            Upper Body
          </div>
          ...
          <div className="menu-group-label text-[10px] opacity-40 font-bold mb-2 ml-4 mt-6 tracking-widest uppercase">
            Lower Body
          </div>
        ...
        <div className="sidebar-actions mt-auto">
          ...
          <button className="btn-close-circle" onClick={() => navigate("/")}>
            ✕
          </button>
        </div>
      </div>
      ...
      <div className="ces-main scroll-y">
        <header className="info-header mb-8">
          ...
          <p className="sub-label opacity-70">
            Corrective Exercise Strategy Reference Guide
          </p>
        </header>
