    ...
    return (
        <div className="ces-player">
            ...
            <div className="ces-player-video">
                <div style={{ width: '100%', maxWidth: '760px' }}>
                    ...
                    <div className="progress-track">
                        <div className="progress-bar" style={{ background: PHASE_META[currentStep.cesPhase].color, width: `${stepProgress}%` }} />
                    </div>
            ...
            <div className="ces-player-anatomy">
                <p style={{ fontSize: '0.65rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>
                    Target Muscles
                </p>
                <BodyAnatomySvg
