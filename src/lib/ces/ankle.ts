...
export const ANKLE_CES: JointCesData = {
    ...
    protocol: {
        plantar_flexion: {
            ...
            lengthen: [ex('ak_len_pf1', '전경골근 스트레칭', '서있는 자세에서 발등을 바닥에 대고 발목을 뒤로 부드럽게 눌러 30초 유지합니다.', '', { holdSeconds: 30, sets: 2 })],
        ...
        dorsi_flexion: {
            ...
            ex('ak_inh_df2', '가자미근 SMR', '마사지볼을 종아리 아래에 대고 무릎을 굽힌 상태로 중간·하부를 롤링합니다.', '', { tools: '마사지볼', holdSeconds: 40 })],
            lengthen: [ex('ak_len_df1', '비복근 스트레칭 (무릎 편 상태)', '벽에 양손을 대고 한 발을 뒤로 빼 발뒤꿈치를 바닥에 붙인 채 30초 유지합니다.', '', { holdSeconds: 30, sets: 2 }),
            ex('ak_len_df2', '가자미근 스트레칭 (무릎 굽힌 상태)', '벽에 양손을 대고 한 발을 뒤로 뺸 상태에서 뒤쪽 무릎을 약간 굽혀 가자미근을 30초 늘입니다.', '', { holdSeconds: 30, sets: 2 })],
        ...
        inversion: {
            ...
            lengthen: [ex('ak_len_inv1', '내번 스트레칭', '서있는 자세에서 발목을 안쪽으로 부드럽게 기울여(내번 방향) 30초 유지합니다.', '', { holdSeconds: 30, sets: 2 })],
        ...
        eversion: {
            ...
            lengthen: [ex('ak_len_ev1', '외번 스트레칭', '서있는 자세에서 발목을 바깥쪽으로 부드럽게 기울여(외번 방향) 30초 유지합니다.', '', { holdSeconds: 30, sets: 2 })],
