...
export const JOINTS: Joint[] = [
  {
    ...
    name: '어깨 (Shoulder)',
    movements: [
      { id: 'flexion', name: '굴곡 (Flexion)', normalRange: 180 },
      { id: 'extension', name: '신전 (Extension)', normalRange: 60 },
      { id: 'abduction', name: '외전 (Abduction)', normalRange: 180 },
      { id: 'adduction', name: '내전 (Adduction)', normalRange: 50 },
      { id: 'internal_rotation', name: '내회전 (Internal Rotation)', normalRange: 70 },
      { id: 'external_rotation', name: '외회전 (External Rotation)', normalRange: 90 },
    ],
  },
  {
    id: 'elbow',
    name: '팔꿈치 (Elbow)',
    movements: [
      { id: 'flexion', name: '굴곡 (Flexion)', normalRange: 150 },
      { id: 'extension', name: '신전 (Extension)', normalRange: 0 },
      { id: 'supination', name: '회외 (Supination)', normalRange: 80 },
      { id: 'pronation', name: '회내 (Pronation)', normalRange: 80 },
    ],
  },
  {
    id: 'wrist',
    name: '손목 (Wrist)',
    movements: [
      { id: 'flexion', name: '굴곡 (Flexion)', normalRange: 80 },
      { id: 'extension', name: '신전 (Extension)', normalRange: 70 },
      { id: 'radial_deviation', name: '요측편위 (Radial Deviation)', normalRange: 20 },
      { id: 'ulnar_deviation', name: '척측편위 (Ulnar Deviation)', normalRange: 30 },
    ],
  },
  {
    id: 'hip',
    name: '고관절 (Hip)',
    movements: [
      { id: 'flexion', name: '굴곡 (Flexion)', normalRange: 120 },
      { id: 'extension', name: '신전 (Extension)', normalRange: 30 },
      { id: 'abduction', name: '외전 (Abduction)', normalRange: 45 },
      { id: 'adduction', name: '내전 (Adduction)', normalRange: 30 },
      { id: 'internal_rotation', name: '내회전 (Internal Rotation)', normalRange: 45 },
      { id: 'external_rotation', name: '외회전 (External Rotation)', normalRange: 45 },
    ],
  },
  {
    id: 'knee',
    name: '무릎 (Knee)',
    movements: [
      { id: 'flexion', name: '굴곡 (Flexion)', normalRange: 135 },
      { id: 'extension', name: '신전 (Extension)', normalRange: 0 },
    ],
  },
  {
    ...
    name: '발목 (Ankle)',
    movements: [
      { id: 'plantar_flexion', name: '저측굴곡 (Plantar Flexion)', normalRange: 50 },
      { id: 'dorsi_flexion', name: '배측굴곡 (Dorsiflexion)', normalRange: 20 },
      { id: 'inversion', name: '내번 (Inversion)', normalRange: 35 },
      { id: 'eversion', name: '외번 (Eversion)', normalRange: 15 },
    ],
  },
  {
    id: 'waist',
    ...
    isSymmetric: true,
    movements: [
      { id: 'lumbar_lordosis', name: '허리 전만 (Lumbar Lordosis)', normalRange: 1, isQualitative: true },
      { id: 'pelvic_tilt', name: '골반 경사 (Pelvic Tilt)', normalRange: 1, isQualitative: true },
    ],
  },
];
